...
import static com.ronginat.family_recipes.layout.APICallsHandler.STATUS_OK;
...
public class RecipeRepository {
     ...
     * {@link com.ronginat.family_recipes.viewmodels.DataViewModel} used by {@link com.ronginat.family_recipes.ui.fragments.RecyclerWithFiltersAbstractFragment}
     */
    ...
    public void fetchRecipesReactive(final Context context, boolean requestedByUser) {
        ...
        new Handler().postDelayed(() -> mayRefresh.getAndSet(true), com.ronginat.family_recipes.utils.Constants.REFRESH_DELAY);
