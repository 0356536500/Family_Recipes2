...
public class Constants {
    ...
    public static final long MIN_APK_FOLDER_SIZE_TO_START_DELETING_CONTENT = 10485760L; //10MB in bytes
    ...
    public static final int TARGET_RECIPE_RECORDS_COUNT_AFTER_DELETING_CONTENT = 500; // max of 1KB each, X 500 records = approximately 500KB for content table
